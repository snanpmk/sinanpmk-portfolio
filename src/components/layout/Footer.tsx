            ...
            {PORTFOLIO_DATA.socialLinks?.map((social) => {
              ...
              return (
                <Link
                  ...
                  className={`p-3 rounded-full bg-white/5 border border-white/5 text-neutral-400 transition-all duration-300 group ${social.hoverText} ${social.hoverBg} ${social.hoverBorder}`}
